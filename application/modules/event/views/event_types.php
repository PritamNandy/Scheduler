            ...
            <div class="col-md-12">
                <section class="card">
                    <header class="card-header">
                        <b style="font-weight: 600; font-size: 20px;"><?php echo lang('event')." ".lang('types');?></b>
                        <button class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> <?php echo lang('add')." ".lang('event')." ".lang('type'); ?></button>
                    </header>
                    <div class="card-body">
                        <div class="adv-table">
                            <table  class="table table-bordered table-striped" id="myTable" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th><?php echo lang('event')." ".lang('type'); ?></th>
                                        <th><?php echo lang('description'); ?></th>
                                        <th><?php echo lang('color'); ?></th>
                                        <th><?php echo lang('font')." ".lang('color'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $event_type->description; ?></td>
                                        <td style="background-color: <?php echo $event_type->color; ?>; padding: 5px;"><?php echo $event_type->color; ?></td>
                                        <td style="background-color: <?php echo $event_type->font_color; ?>; padding: 5px;"><?php echo $event_type->font_color; ?></td>
                                        <td><a class="btn btn-sm btn-warning edit" href="<?php echo site_url('event/editEventType/?id='.$event_type->id); ?>"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?></a> <a class="btn btn-sm btn-danger" href="<?php echo site_url('event/deleteEventType/?id='.$event_type->id); ?>" onclick="confirm('Are you sure?')"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                        <?php if($event_type->status == 1) { ?>
                                            <a class="btn btn-primary btn-sm" href="<?php echo site_url('event/eventTypeStatus/?id='.$event_type->id."&status=0"); ?>">Active</a>
                                        <?php } else { ?>
                                            <a class="btn btn-secondary btn-sm" href="<?php echo site_url('event/eventTypeStatus/?id='.$event_type->id."&status=1"); ?>">Inactive</a>
                                        <?php } ?>
                                        </td>
                                    </tr>
                                    <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo lang('add')." ".lang('event')." ".lang('type'); ?></h5>
      ...
      <div class="modal-body">
          <form action="<?php echo site_url('event/addEditEventType'); ?>" method="post">
              ...
              <div class="form-group">
                  ...
                  <div id="cp2" class="input-group colorpicker-component mb-3 colorpicker-element" title="Using input value" data-colorpicker-id="2">
                      <input type="text" class="form-control input-lg" name="font_color" value="#328dff">
                      <div class="input-group-append">
                          <span class="input-group-addon btn btn-outline-secondary"><i style="background-color: rgb(50, 141, 255);"></i></span>
                      </div>
                  </div>
