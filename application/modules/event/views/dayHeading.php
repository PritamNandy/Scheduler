            ...
            <div class="col-md-12">
                <section class="card">
                    <header class="card-header">
                        <b style="font-weight: 600; font-size: 20px;"><?php echo lang('day')." ".lang('heading');?></b>
                        <button class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> <?php echo lang('add')." ".lang('day')." ".lang('heading'); ?></button>
                    </header>
                    <div class="card-body">
                        <div class="adv-table">
                            <table  class="table table-bordered table-striped" id="myTable" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th><?php echo lang('day')." ".lang('heading'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $day_heading->name; ?></td>
                                        <td><?php echo $day_heading->description; ?></td>
                                        <td><a class="btn btn-sm btn-warning edit" href="<?php echo site_url('event/editDayHeading/?id='.$day_heading->id); ?>" data-id="<?php echo $day_heading->id; ?>"><i class="fa fa-edit"></i> <?php echo lang('edit'); ?></a> <a class="btn btn-sm btn-danger" href="<?php echo site_url('event/deleteDayHeading/?id='.$day_heading->id); ?>" onclick="confirm('Are you sure?')"><i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?></a>
                                        <?php if($day_heading->status == 1) { ?>
                                            <a class="btn btn-primary btn-sm" href="<?php echo site_url('event/dayHeadingStatus/?id='.$day_heading->id."&status=0"); ?>">Active</a>
                                        <?php } else { ?>
                                            <a class="btn btn-secondary btn-sm" href="<?php echo site_url('event/dayHeadingStatus/?id='.$day_heading->id."&status=1"); ?>">Inactive</a>
                                        <?php } ?>
                                        </td>
                                    </tr>
                                    <?php } ?>
...
<!-- Add Event Types Modal -->
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo lang('add')." ".lang('day')." ".lang('heading'); ?></h5>
      ...
      <div class="modal-body">
          <form action="<?php echo site_url('event/addEditDayHeading'); ?>" method="post">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="day_heading" placeholder="Enter day heading name">
              </div>
              <div class="form-group">
                  <label for="exampleInputPassword1"><?php echo lang('description'); ?></label>
                  <textarea class="form-control" id="exampleInputPassword1" name="description" placeholder="Enter description of day heading"></textarea>
              </div>
      </div>
