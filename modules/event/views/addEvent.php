                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 textTimeInput">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="input-group bootstrap-timepicker">
                                                <input type="text" class="form-control rounded mr-3 " name="start_time" aria-label="Right Icon" aria-describedby="basic-addon15" value="After Lunch">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 textTimeInput">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <div class="input-group bootstrap-timepicker">
                                                <input type="text" class="form-control rounded mr-3 " name="end_time" aria-label="Right Icon" aria-describedby="basic-addon15" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
